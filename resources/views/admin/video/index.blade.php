            ...
            <div class="form-group">
              <div class="input-group mb-3">
                ...
                <div class="input-group-prepend">
                  <a href="{{ route('admin.video.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i
                      class="fa fa-plus-circle"></i> TAMBAH</a>
                </div>
                @endcan
                <input type="text" class="form-control" name="q" placeholder="cari berdasarkan judul video">
          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row" style="text-align: center">{{ ++$no + ($videos->currentPage()-1) * $videos->perPage()
                    }}</th>
                  <td>{{ $video->title }}</td>
                  <td class="text-center">
                    <iframe width="300" height="150" src="{{ $video->embed }}" frameborder="0"
