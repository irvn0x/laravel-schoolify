          ...
          <form action="{{ route('admin.video.update', $video->id) }}" method="POST">
            ...
            <div class="form-group">
              ...
              <input type="text" name="title" value="{{ old('title', $video->title) }}"
                placeholder="Masukkan Judul Video" class="form-control @error('title') is-invalid @enderror">
            ...
            <div class="form-group">
              ...
              <input type="text" name="embed" value="{{ old('embed', $video->embed) }}"
                placeholder="Masukkan Embed YouTube" class="form-control @error('embed') is-invalid @enderror">
