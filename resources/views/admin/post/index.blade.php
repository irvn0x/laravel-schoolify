            ...
            <div class="form-group">
              <div class="input-group mb-3">
                ...
                <div class="input-group-prepend">
                  <a href="{{ route('admin.post.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i
          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row" style="text-align: center">{{ ++$no + ($posts->currentPage()-1) * $posts->perPage() }}
                  </th>
                  <td>{{ $post->title }}</td>
