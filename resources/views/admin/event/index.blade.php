            ...
            <div class="form-group">
              <div class="input-group mb-3">
                ...
                <div class="input-group-prepend">
                  <a href="{{ route('admin.event.create') }}" class="btn btn-primary" style="padding-top: 10px;"><i
          ...
          <div class="table-responsive">
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <th scope="row" style="text-align: center">{{ ++$no + ($events->currentPage()-1) * $events->perPage()
                    }}</th>
                  <td>{{ $event->title }}</td>
