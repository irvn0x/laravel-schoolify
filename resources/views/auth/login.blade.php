...
<head>
    ...
    <title>Login &mdash; Schoolify</title>

    <link rel="shortcut icon" href="{{ asset('assets/img/graduate.svg') }}" type="image/x-icon">
                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="{{ asset('assets/img/graduate.svg') }}" alt="logo" width="100"
